...
const Blogs = () => {
  return (
    <div className="w-screen h-screen  m-auto justify-center items-center flex flex-col md:flex-row gap-10 bg-gradient-to-br from-teal-400 to-teal-900 overflow-y-hidden">
      <Link to="/technical">
