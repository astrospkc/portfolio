  ...
  return (
    <>
      <div className="h-full bg-gradient-to-r   md:m-7  flex flex-col justify-center items-center  w-screen  md:p-5">
        <div>
          <h1 className="text-3xl md:text-5xl text-center font-bold text-white w-fit bg-violet-900 rounded-full p-3">
            Projects
          </h1>
        </div>
        <div className="grid grid-col-2 gap-3">
          {/* blogging app */}
          <div className="justify-center items-center m-4   p-3 shadow-lg shadow-black w-fit  rounded-xl">
            <div className="mx-16 my-9 md:my-1 relative hover:cursor-pointer opacity-70 hover:opacity-100  hover:text-3xl  rounded-3xl text-gray-500 hover:text-white">
              <img src={image} alt="" className="w-full rounded-xl  " />
              <div className="absolute top-[50%] left-[30%] ">
                <h1 className="text-bold text-xl md:text-3xl hover:text-3xl">
                  V-Blog
                </h1>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-1 my-5 skillsanimate justify-center items-center  ">
            ...
            <div className="flex  flex-col justify-center items-center m-4   p-3 shadow-lg shadow-black w-fit  rounded-xl">
              ...
              <div className="mx-4 flex flex-col justify-center items-center">
                ...
                <p className="multiline text-white min-w-fit">
                  ...
                  The best thing I learned about is how to implement
            ...
            <div className="flex  flex-col justify-center items-center m-4   p-3 shadow-lg shadow-black w-fit  rounded-xl">
              ...
              <div className="mx-4 flex flex-col justify-center items-center">
                ...
                <p className="multiline text-white">
                  A simple 2 page food recipe website which let users know all
                  the ingredients that were added in making respective food
                  item.
                  <div className=""></div>
                </p>
                <div className="flex flex-row">
